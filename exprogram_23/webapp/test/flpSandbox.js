		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (23)",
									"targetURL": "#examexprogram23-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram23-display": {
								"semanticObject": "examexprogram23",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram23",
									"url": sap.ui.require.toUrl("exam/exprogram23")
								}
							}
						}
					}
